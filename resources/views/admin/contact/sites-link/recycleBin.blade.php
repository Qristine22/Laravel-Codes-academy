        ...
        <section class="admin-section">
            ...
            <table class="table">
                <tr>
                    ...
                    <th class="th text-18" style="width: 5%">icon</th>
                    ...
                    <tr>
                        ...
                        <td class="td text-18">
                            <div class="table__panel flex">
                                <a class="table__panel_item" href="{{ route('admin.contact.sites-link.recycleBinRestore',
                                    ['id' => $item]) }}">
                                    <i class="fas fa-trash-restore"></i>
                                </a>
                                <form action="{{ route('admin.contact.sites-link.forceDelete', ['id' => $item]) }}" method="GET">
                                    @csrf
                                    @method('DELETE')
