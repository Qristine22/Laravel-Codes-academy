...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <form class="admin__form" action="{{ route('admin.contact.page.store') }}" method="POST">
                @csrf
                @if ($errors->any())
                    ...
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="address__en" name="address_en"
                                placeholder="Enter your text here" value="{{ old('address_en') }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="address__am" name="address_am"
                                placeholder="Enter your text here" value="{{ old('address_am') }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="address__ru" name="address_ru"
                                placeholder="Enter your text here" value="{{ old('address_ru') }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                        ...
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="map" name="map"
                                placeholder="Enter your text here" value="{{ old('map') }}">
                        </div>
                    </div>
                </div>
