...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <form class="admin__form" action="{{ route('admin.bulletin.info.update',
                ['info' => $info]) }}"
                    ...
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__en" name="name_en"
                                placeholder="Enter your text here" value="{{ $info->name_en }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__am" name="name_am"
                                placeholder="Enter your text here" value="{{ $info->name_am }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__ru" name="name_ru"
                                placeholder="Enter your text here" value="{{ $info->name_ru }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                ...
                <input type="hidden" name="pdfHidden" value="{{ $info->pdf }}">
