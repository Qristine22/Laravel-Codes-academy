    ...
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <form class="admin__form"
                action="{{ route('admin.about.rectors-biography.update',
                ['rectors_biography' => $rectorsBiography]) }}"
                    ...
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__en" name="name_en"
                                placeholder="Enter your text here" value="{{ $rectorsBiography->name_en }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__am" name="name_am"
                                placeholder="Enter your text here" value="{{ $rectorsBiography->name_am }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__ru" name="name_ru"
                                placeholder="Enter your text here" value="{{ $rectorsBiography->name_ru }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="position__en" name="position_en"
                                placeholder="Enter your text here" value="{{ $rectorsBiography->position_en }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="position__am" name="position_am"
                                placeholder="Enter your text here" value="{{ $rectorsBiography->position_am }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="position__ru" name="position_ru"
                                placeholder="Enter your text here" value="{{ $rectorsBiography->position_ru }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                    ...
                    <div class="form__text">
                        <div class="form__item">
                            ...
                            <textarea class="ckeditor" name="biography_en" id="biography__en"
                                placeholder="Enter Your Text Here">{{ $rectorsBiography->biography_en }}
                            </textarea>
                        </div>
                        <div class="form__item">
                            ...
                            <textarea class="ckeditor" name="biography_am" id="biography__am"
                                placeholder="Enter Your Text Here">{{ $rectorsBiography->biography_am }}
                            </textarea>
                        </div>
                        <div class="form__item">
                            ...
                            <textarea class="ckeditor" name="biography_ru" id="biography__ru"
                                placeholder="Enter Your Text Here">{{ $rectorsBiography->biography_ru }}
                            </textarea>
                        </div>
                    </div>
                </div>
                ...
                <input type="hidden" name="imgHidden" value="{{ $rectorsBiography->img }}">
