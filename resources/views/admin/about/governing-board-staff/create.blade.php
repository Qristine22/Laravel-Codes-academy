...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <form class="admin__form" action="{{ route('admin.about.governing-board-staff.store') }}" method="POST"
                ...
                <div class="form__text">
                    ...
                    <div class="form__text">
                        <div class="form__item">
                            ...
                            <textarea class="ckeditor" name="biography" id="biography" placeholder="Enter Your Text Here">
                                {{ old('biography') }}
                            </textarea>
                        </div>
                    </div>
