            ...
            <form class="admin__form" action="{{ route('admin.about.page.update', ['page' => $about]) }}" method="POST">
                ...
                <div class="form__text">
                    <div class="form__item">
                        ...
                        <textarea name="about_en" id="about__en"
                            placeholder="Enter Your Text Here">{{ $about->about_en }}</textarea>
                    </div>
                    <div class="form__item">
                        <label class="text-20 form__item_name" for="about__am">About (Armenian)</label>
                        <textarea name="about_am" id="about__am"
                            placeholder="Enter Your Text Here">{{ $about->about_am }}</textarea>
                    </div>
                    <div class="form__item">
                        <label class="text-20 form__item_name" for="about__ru">About (Russian)</label>
                        <textarea name="about_ru" id="about__ru"
                            placeholder="Enter Your Text Here">{{ $about->about_ru }}</textarea>
                    </div>
                </div>
