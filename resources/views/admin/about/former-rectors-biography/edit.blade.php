        ...
        <section class="admin-section">
            ...
            <form class="admin__form"
                ...
                <div class="form__text">
                    ...
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            <img class="img__file_reader" src="{{ Storage::url($formerRectorsBiography->img) }}" alt="">
                    ...
                    <div class="form__text">
                        <div class="form__item">
                            ...
                            <textarea class="ckeditor" name="biography_en" id="biography__en"
                                placeholder="Enter Your Text Here">{{ $formerRectorsBiography->biography_en }}
                            </textarea>
                        </div>
                        <div class="form__item">
                            ...
                            <textarea class="ckeditor" name="biography_am" id="biography__am"
                                placeholder="Enter Your Text Here">{{ $formerRectorsBiography->biography_am }}
                            </textarea>
                        </div>
                        <div class="form__item">
                            ...
                            <textarea class="ckeditor" name="biography_ru" id="biography__ru"
                                placeholder="Enter Your Text Here">{{ $formerRectorsBiography->biography_ru }}
                            </textarea>
                        </div>
                    </div>
                </div>
