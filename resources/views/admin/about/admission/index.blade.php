...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            @if (count($data) == 0)
                <a class="admin-item__create" href="{{ route('admin.about.admission.create') }}">
                        ...
                        <td class="td text-18">
                            <div class="table__panel flex">
                                <a class="table__panel_item"
                                    href="{{ route('admin.about.admission.edit', ['admission' => $item]) }}">
        ...
        <section class="admin-section">
            ...
            @if (count($candidates) < 3)
                <a class="admin-item__create" href="{{ route('admin.about.candidate.create') }}">
                    <span class="admin-item__plus">+</span>
                </a>
            @endif
            <table class="table">
                ...
                @foreach ($candidates as $item)
                    <tr>
                        ...
                        <td class="td text-18">
                            <div class="table__panel flex">
                                <a class="table__panel_item"
                                    href="{{ route('admin.about.candidate.edit', ['candidate' => $item]) }}">
                                    <img class="img" src="/media/img/icons/edit.png" alt="edit">
                                </a>
                            </div>
                        </td>
