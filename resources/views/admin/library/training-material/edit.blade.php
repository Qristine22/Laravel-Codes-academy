...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <form class="admin__form" action="{{ route('admin.library.training-material.update',
                    ...
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__en" name="name_en"
                                placeholder="Enter your text here" value="{{ $trainingMaterial->name_en }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__am" name="name_am"
                                placeholder="Enter your text here" value="{{ $trainingMaterial->name_am }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__ru" name="name_ru"
                                placeholder="Enter your text here" value="{{ $trainingMaterial->name_ru }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            <span class="text-20 form__item_name">Photo</span>
                            <img class="img__file_reader" src="{{ Storage::url($trainingMaterial->img) }}" alt="">
                ...
                <input type="hidden" name="pdfHidden" value="{{ $trainingMaterial->pdf }}">
                <input type="hidden" name="imgHidden" value="{{ $trainingMaterial->img }}">
