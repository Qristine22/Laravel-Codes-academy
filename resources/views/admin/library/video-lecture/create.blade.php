...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <form class="admin__form" action="{{ route('admin.library.video-lecture.store') }}" method="POST">
                @csrf
                @if ($errors->any())
                    ...
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="topic__en" name="topic_en"
                                placeholder="Enter your text here" value="{{ old('topic_en') }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="topic__am" name="topic_am"
                                placeholder="Enter your text here" value="{{ old('topic_am') }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="topic__ru" name="topic_ru"
                                placeholder="Enter your text here" value="{{ old('topic_ru') }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="lecturer__en" name="lecturer_en"
                                placeholder="Enter your text here" value="{{ old('lecturer_en') }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="lecturer__am" name="lecturer_am"
                                placeholder="Enter your text here" value="{{ old('lecturer_am') }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="lecturer__ru" name="lecturer_ru"
                                placeholder="Enter your text here" value="{{ old('lecturer_ru') }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
