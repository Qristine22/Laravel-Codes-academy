    ...
    <div class="admin__sections">
        <section class="admin-section">
            <div class="admin__head">
                <h2 class="admin__title">Քրեական դատավարության օրենսգրքեր</h2>
            </div>

            <form class="admin__form" action="{{ route('admin.library.criminal-procedure-codes.update', ['criminal_procedure_code' => $criminalProcedureCodes]) }}" method="POST"
                    ...
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="text__en" name="text_en"
                                   placeholder="Enter your text here" value="{{ $criminalProcedureCodes->text_en }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="text__am" name="text_am"
                                   placeholder="Enter your text here" value="{{ $criminalProcedureCodes->text_am }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="text__ru" name="text_ru"
                                   placeholder="Enter your text here" value="{{ $criminalProcedureCodes->text_ru }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
{{--                        <div class="form__item form__item-inp">--}}
...
{{--                        </div>--}}
                        ...
                        <div class="form__item form__item-inp">
                            ...
                            <select name="type">
                                <option @if($criminalProcedureCodes->type == 1) selected @endif value="1">{{ __('criminal-procedure-codes.new_ra_criminal_code') }}</option>
                                <option @if($criminalProcedureCodes->type == 2) selected @endif value="2">{{ __('criminal-procedure-codes.new_ra_criminal_procedure_code') }}</option>
                                <option @if($criminalProcedureCodes->type == 3) selected @endif value="3">{{ __('criminal-procedure-codes.new_codes') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="syllabus_pdf_name__en" name="syllabus_pdf_name_en"
                                   placeholder="Enter your text here" value="{{ $criminalProcedureCodes->syllabus_pdf_name_en }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="syllabus_pdf_name__am" name="syllabus_pdf_name_am"
                                   placeholder="Enter your text here" value="{{ $criminalProcedureCodes->syllabus_pdf_name_am }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="syllabus_pdf_name__ru" name="syllabus_pdf_name_ru"
                                   placeholder="Enter your text here" value="{{ $criminalProcedureCodes->syllabus_pdf_name_ru }}">
                        </div>
                    </div>
{{--                    <div class="flex inputs__group">--}}
{{--                        <div class="form__item form__item-inp">--}}
