...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <a class="admin-item__create admin-item__add" href="{{ route('admin.full-time-education.provide-deferral.create') }}">
                <span class="admin-item__plus">+</span>
            </a>
            <a class="admin-item__create admin-item__trash"
                href="{{ route('admin.full-time-education.provide-deferral.recycleBin') }}">
