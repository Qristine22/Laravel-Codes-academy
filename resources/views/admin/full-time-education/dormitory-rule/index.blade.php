...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <a class="admin-item__create admin-item__add" href="{{ route('admin.full-time-education.dormitory-rule.create') }}">
                <span class="admin-item__plus">+</span>
            </a>
            <a class="admin-item__create admin-item__trash"
                href="{{ route('admin.full-time-education.dormitory-rule.recycleBin') }}">
                        ...
                        <td class="td text-18">
                            <div class="table__panel flex">
                                <a class="table__panel_item"
                                    href="{{ route('admin.full-time-education.dormitory-rule.edit',
                                    ['dormitory_rule' => $item]) }}">
                                    <img class="img" src="/media/img/icons/edit.png" alt="edit">
                                </a>
                                <form
                                    action="{{ route('admin.full-time-education.dormitory-rule.destroy',
                                    ['dormitory_rule' => $item]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
