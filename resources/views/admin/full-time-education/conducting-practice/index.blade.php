    ...
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <table class="table">
                ...
                @foreach ($conductingPractice as $item)
                    <tr>
                        ...
                        <td class="td text-18">
                            <div class="table__panel flex">
                                <a class="table__panel_item"
                                    href="{{ route('admin.full-time-education.conducting-practice.edit',
                                    ['conducting_practice' => $item]) }}">
                                    <img class="img" src="/media/img/icons/edit.png" alt="edit">
                                </a>
                                <form
                                    action="{{ route('admin.full-time-education.conducting-practice.destroy',
                                    ['conducting_practice' => $item]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
            ...
            {{ $conductingPractice->links('includes.pagination.paginate') }}
        </section>
    </div>
@endsection
