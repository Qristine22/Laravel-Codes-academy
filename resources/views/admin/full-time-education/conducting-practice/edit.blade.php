    ...
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <form class="admin__form"
                action="{{ route('admin.full-time-education.conducting-practice.update',
                ['conducting_practice' => $conductingPractice]) }}"
                    ...
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__en" name="name_en"
                                placeholder="Enter your text here" value="{{ $conductingPractice->name_en }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__am" name="name_am"
                                placeholder="Enter your text here" value="{{ $conductingPractice->name_am }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__ru" name="name_ru"
                                placeholder="Enter your text here" value="{{ $conductingPractice->name_ru }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                ...
                <input type="hidden" name="pdfHidden" value="{{ $conductingPractice->pdf }}">
