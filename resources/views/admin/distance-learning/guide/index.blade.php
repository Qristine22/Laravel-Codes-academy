...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            @if (count($guides) == 0)
                <a class="admin-item__create" href="{{ route('admin.distance-learning.guide.create') }}">
                        ...
                        <td class="td text-18">
                            <div class="table__panel flex">
                                <a class="table__panel_item"
                                    href="{{ route('admin.distance-learning.guide.edit',
                                    ['guide' => $item]) }}">
            ...
            {{ $guides->links('includes.pagination.paginate') }}
        </section>
    </div>
@endsection
