    ...
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <form class="admin__form"
                action="{{ route('admin.distance-learning.motivational-video.update',
                    ['motivational_video' => $motivationalVideo]) }}" method="POST">
                @csrf
                @method('PUT')
                @if ($errors->any())
                    ...
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__en" name="name_en"
                                placeholder="Enter your text here" value="{{ $motivationalVideo->name_en }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__am" name="name_am"
                                placeholder="Enter your text here" value="{{ $motivationalVideo->name_am }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__ru" name="name_ru"
                                placeholder="Enter your text here" value="{{ $motivationalVideo->name_ru }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="video" name="video"
                                placeholder="Enter your text here" value="{{ $motivationalVideo->video }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <select class="admin-inp" name="course_id" id="course">
                                @foreach($courses as $course)
                                    <option value="{{ $course->id }}"
                                        @if($course->id === $motivationalVideo->course_id)selected @endif>
                                        {{ $course->name_am }}
                                    </option>
                                @endforeach
                            </select>
