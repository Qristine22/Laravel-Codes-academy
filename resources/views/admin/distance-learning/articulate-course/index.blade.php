...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <a class="admin-item__create admin-item__add" href="{{ route('admin.distance-learning.articulate.create') }}">
                <span class="admin-item__plus">+</span>
            </a>
            <a class="admin-item__create admin-item__trash"
                href="{{ route('admin.distance-learning.articulate.recycleBin') }}">
                        ...
                        <td class="td text-18">
                            <div class="table__panel flex">
                                <a class="table__panel_item"
                                    href="{{ route('admin.distance-learning.articulate.edit',
                                    ['articulate' => $item]) }}">
                                    <img class="img" src="/media/img/icons/edit.png" alt="edit">
                                </a>
                                <form
                                    action="{{ route('admin.distance-learning.articulate.destroy',
                                    ['articulate' => $item]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
            ...
            {{ $articulates->links('includes.pagination.paginate') }}
        </section>
    </div>
@endsection
