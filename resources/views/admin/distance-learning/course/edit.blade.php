...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <form class="admin__form" action="{{ route('admin.distance-learning.courses.update',
                ['course' => $course]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                @if ($errors->any())
                    ...
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__en" name="name_en"
                                placeholder="Enter your text here" value="{{ $course->name_en }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__am" name="name_am"
                                placeholder="Enter your text here" value="{{ $course->name_am }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="name__ru" name="name_ru"
                                placeholder="Enter your text here" value="{{ $course->name_ru }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="syllabus_pdf_name__en" name="syllabus_pdf_name_en"
                                placeholder="Enter your text here" value="{{ $course->syllabus_pdf_name_en }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="syllabus_pdf_name__am" name="syllabus_pdf_name_am"
                                placeholder="Enter your text here" value="{{ $course->syllabus_pdf_name_am }}">
                        </div>
                        <div class="form__item form__item-inp">
                            ...
                            <input class="admin-inp" type="text" id="syllabus_pdf_name__ru" name="syllabus_pdf_name_ru"
                                placeholder="Enter your text here" value="{{ $course->syllabus_pdf_name_ru }}">
                        </div>
                    </div>
                    <div class="flex inputs__group">
                        <div class="form__item form__item-inp">
                            <span class="text-20 form__item_name">Photo</span>
                            <img class="img__file_reader" src="{{ Storage::url($course->img) }}" alt="">
                ...
                <input type="hidden" name="pdfHidden" value="{{ $course->syllabus_pdf }}">
                <input type="hidden" name="imgHidden" value="{{ $course->img }}">
