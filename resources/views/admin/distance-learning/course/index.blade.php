...
@section('content')
    <div class="admin__sections">
        <section class="admin-section">
            ...
            <a class="admin-item__create admin-item__add" href="{{ route('admin.distance-learning.courses.create') }}">
                <span class="admin-item__plus">+</span>
            </a>
            <a class="admin-item__create admin-item__trash"
                href="{{ route('admin.distance-learning.courses.recycleBin') }}">
            ...
            <table class="table">
                <tr>
                    ...
                    <th class="th text-18">Syllabus</th>
                ...
                @foreach ($courses as $item)
                    <tr>
                        ...
                        <td class="td text-18">{!! $item->syllabus_am !!}</td>
                        <td class="td">
                        ...
                        <td class="td text-18">
                            <div class="table__panel flex">
                                <a class="table__panel_item"
                                    href="{{ route('admin.distance-learning.courses.edit',
                                    ['course' => $item]) }}">
                                    <img class="img" src="/media/img/icons/edit.png" alt="edit">
                                </a>
                                <form
                                    action="{{ route('admin.distance-learning.courses.destroy',
                                    ['course' => $item]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
            ...
            {{ $courses->links('includes.pagination.paginate') }}
        </section>
    </div>
@endsection
