            ...
            <div class="wrapper">
                <div class="materials__cont">
                    <div class="materials__item">
                        <h3 class="material__title text-20">Դաս 1</h3>
                        <ul class="material__list">
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                                    1.Առաքելյան Ս.Վ. Կանանց իրավական պաշտպանությունը բռնությունից: Երևան, 2001
                                </a>
                            </li>
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                                    2. ՀՀ վճռաբեկ դատարանի 2012թ. նոյեմբերի 1-ի թիվ ԱՐԴ/0176/01/11 որոշումը
                                </a>
                            </li>
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                                    3. ՀՀ վճռաբեկ դատարանի 2012թ. հունիսի 8-ի թիվ ԿԴ1/0025/01/11որոշումը
                                </a>
                            </li>
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                                    4.World report on violence and health/ Edited by Etienne G. Krug, WHO, 2002
                                </a>
                            </li>
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                                    5.Костров Г.К. Психическое насилие при разбое и грабеже // Советская юстиция, 1970
                                </a>
                            </li>
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                    ...
                    <div class="materials__item">
                        <h3 class="material__title text-20">Դաս 2</h3>
                        <ul class="material__list">
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                            ...
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                                    5.Tracy N. Emotional Abuse: Definitions, Signs, Symptoms, Examples, HealthyPlace.
                                </a>
                            </li>
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                                    6.Acts of Omission: An Overview of Child Neglect, Bulletin for Professionals, July 2018.
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="materials__item">
                        <h3 class="material__title text-20">Դաս 3</h3>
                        <ul class="material__list">
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                    ...
                    <div class="materials__item">
                        <h3 class="material__title text-20">Դաս 4</h3>
                        <ul class="material__list">
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                            ...
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                                    5.ՌԴ սահմանադրական դատարանի 2005 թվականի հունվարի 18-ի թիվ 131-Օ որոշումը
                                </a>
                            </li>
                            <li class="material__list_item">
                                <a class="material__link text-18" href="#">
                                    6. «Երեխայի իրավունքների մասին» 1989 թվականի նոյեմբերի 20-ի ՄԱԿ-ի կոնվենցիա //
                                </a>
                            </li>
                        </ul>
                    </div>
