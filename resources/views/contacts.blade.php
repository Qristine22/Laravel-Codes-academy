...
<body>
    ...
    <main>
                ...
                <div class="contacts__top flex">
                    <div class="contacts__block">
                        <div class="contacts__map">
                            <iframe class="img contacts__map_iframe" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3046.5215063186283!2d44.496839060420236!3d40.21970557552195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x406a97fe331a7b65%3A0xc221f33da2130e48!2z1LHVkNS01LHVkNSx1LTUsdWP1YjVktS51YXUsdWGINSx1L_UsdS01LXVhNS71LEgKEFjYWRlbXkgb2YgSnVzdGljZSk!5e0!3m2!1sru!2s!4v1639650221284!5m2!1sru!2s" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        </div>
                        <div class="contacts__info">
                            <h3 class="contacts__title text-26">Հետադարձ կապ</h3>
                            <div class="contacts__about">
                                <span class="contacts__about_name text-20">Հասցե:</span>
                                <span class="contacts__about_info text-20">ՀՀ, ք. Երևան, 0054, Փիրումյանների փող. 9</span>
                            </div>
                            <div class="contacts__about">
                                <span class="contacts__about_name text-20">Էլ. փոստ:</span>
                                <span class="contacts__about_info text-20">info@justiceacademy.am</span>
                            </div>
                            <div class="contacts__about">
                                <span class="contacts__about_name text-20">Հեռ.:</span>
                                <span class="contacts__about_info text-20">+374-60-460087</span>
                            </div>
                        </div>
                    </div>
                    <div class="contacts__block contacts__message">
                        <h3 class="contacts__title text-26">Նամակ ռեկտորին</h3>
                        <form class="contacts__form" action="#">
                            <div class="contacts__form_inps flex">
                                <input class="inp text-18 contacts__inp contacts__inp-top" type="text" placeholder="Անուն">
                                <input class="inp text-18 contacts__inp contacts__inp-top" type="text" placeholder="Էլ․ Փոստ">
                            </div>
                            <div class="contacts__form_inps flex">
                                <input class="inp text-18 contacts__inp" type="text" placeholder="Թեմա">
                            </div>
                            <div class="contacts__form_inps flex">
                                <textarea class="contacts__textarea inp text-18 contacts__inp" name="" placeholder="Բովանդակություն"></textarea>
                            </div>
                            <div class="contacts__form_inps flex">
                                <button class="contacts__btn text-18">
                                    <span class="contacts__btn_span">Ուղարկել</span>
                                </button>
                            </div>
                        </form>
                    </div>
        ...
        <section class="staff section-text">
            <div class="wrapper">
                <h3 class="contacts__title text-26">Անձնակազմ</h3>
