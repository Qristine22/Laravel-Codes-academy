                    ...
                    <div class="contacts__block">
                        ...
                        <div class="contacts__info">
                            ...
                            <div class="contacts__about">
                                ...
                                <span class="contacts__about_info text-20">ՀՀ, ք. Երևան, 0054, Փիրումյանների փող.
                                    9</span>
                            </div>
                            <div class="contacts__about">
                    ...
                    <div class="contacts__block contacts__message">
                        ...
                        <form class="contacts__form" action="#">
                            <div class="contacts__form_inps flex">
                                ...
                                <input class="inp text-18 contacts__inp contacts__inp-top" type="text"
                                    placeholder="Էլ․ Փոստ">
                            </div>
                            <div class="contacts__form_inps flex">
                            ...
                            <div class="contacts__form_inps flex">
                                <textarea class="contacts__textarea inp text-18 contacts__inp" name=""
                                    placeholder="Բովանդակություն"></textarea>
                            </div>
                            <div class="contacts__form_inps flex">
