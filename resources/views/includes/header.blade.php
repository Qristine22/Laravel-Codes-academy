        ...
        <div class="instruments">
            <div class="resize-buttons">
                ...
                <button class="restartButton">
                    <svg fill="#000000" viewBox="-7.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="wrapper">
       <h1 class="sr-only" aria-label="Արդարադատության Ակադեմիա - ԱՐԴԱՐԱԴԱՏՈւԹՅԱՆ ԱԿԱԴԵՄԻԱ">Արդարադատության Ակադեմիա - ԱՐԴԱՐԱԴԱՏՈւԹՅԱՆ ԱԿԱԴԵՄԻԱ</h1>
        <div class="header__cont flex">
            ...
            <div class="instruments-wrapper-mobile">
                <div class="instruments">
                    <div class="resize-buttons">
                        <button class="downButton">A-</button>
                        <button class="upButton">A+</button>
                        <button class="restartButton"><svg fill="#000000" viewBox="-7.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" transform="rotate(-45)">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <title>restart</title>
