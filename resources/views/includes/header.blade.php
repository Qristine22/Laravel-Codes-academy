        ...
        <ul class="header-mob__list">
            @foreach ($headers as $header)
                <li class="header-mob__item">
                    <a class="header__link{{ count($header->subheaders) ?'' : ' header-mob__item-single' }}{{
                        Request::is($header->link, $header->link . '/*') ?' header__menu_link-active' :'' }}"
                        href="{{ env('APP_URL').$header->link }}">
                        {{ $header->{'name_'.app()->getLocale()} }}
                    </a>
                        ...
                        <ul class="header-mob__menu_list">
                            @foreach ($header->subheaders as $subheader)
                                <li class="header-mob__menu_item">
                                    <a class="header__menu_link @if(Request::is($subheader->link,
                                        $subheader->link . '/*'))header__menu_link-active @endif"
