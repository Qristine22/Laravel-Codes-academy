<header class="admin-header">
    ...
    <div class="admin-nav">
        <ul class="admin-header__list">
                ...
                <ul class="admin-header__menu-list">
                    ...
                    <li class="admin-header__menu-item">
                        <a class="text-18 admin-header__menu-link @if(Request::is('admin/about/rectors-page') ||
                            ...
                            || Request::is('admin/about/rectors-decree/*')
                            || Request::is('admin/about/recycleBin/rectors-page')
                            || Request::is('admin/about/recycleBin/rectors-page/*')) admin-header__link-active @endif"
                    ...
                    <li class="admin-header__menu-item">
                        <a class="text-18 admin-header__menu-link @if(Request::is('admin/about/report') ||
                            Request::is('admin/about/report/*') ||
                            Request::is('admin/about/recycleBin/report') ||
                            Request::is('admin/about/recycleBin/report/*')) admin-header__link-active @endif"
                    ...
                    <li class="admin-header__menu-item">
                        ...
                        Request::is('admin/about/graduates/*')||
                        Request::is('admin/about/recycleBin/graduates') ||
                        Request::is('admin/about/recycleBin/graduates/*')) admin-header__link-active @endif"
                    ...
                    <li class="admin-header__menu-item">
                        ...
                        Request::is('admin/about/mass-media/*') ||
                        Request::is('admin/about/recycleBin/mass-media') ||
                        Request::is('admin/about/recycleBin/mass-media/*')) admin-header__link-active @endif"
            ...
            <li class="admin-header__item">
                <div class="admin-header__item_cont flex">
                    <a class="text-20 admin-header__link @if(Request::is('admin/news') || Request::is('admin/news/*') ||
                    Request::is('admin/recycleBin/news') ||Request::is('admin/recycleBin/news/*')
                    ) admin-header__link-active @endif" href="{{ route('admin.news.index') }}">Նորություննր</a>
                </div>
            </li>
            <li class="admin-header__item">
                <div class="admin-header__item_cont flex">
                ...
                <ul class="admin-header__menu-list">
                    <li class="admin-header__menu-item">
                        ...
                        Request::is('admin/full-time-education/training-program/*') ||
                        Request::is('admin/full-time-education/recycleBin/training-program') ||
                        Request::is('admin/full-time-education/recycleBin/training-program/*')) admin-header__link-active @endif"
                    ...
                    <li class="admin-header__menu-item">
                        ...
                        Request::is('admin/full-time-education/conducting-exam/*') ||
                        Request::is('admin/full-time-education/conducting-exam-video') ||
                        Request::is('admin/full-time-education/conducting-exam-video/*') ||
                        Request::is('admin/full-time-education/recycleBin/conducting-exam') ||
                        Request::is('admin/full-time-education/recycleBin/conducting-exam/*') ||
                        Request::is('admin/full-time-education/recycleBin/conducting-exam-video/*')
                        ) admin-header__link-active @endif" href="{{ route('admin.full-time-education.conducting-exam.index') }}">
                            Քննությունների անցկացման կարգ
                        </a>
                    </li>
                    <li class="admin-header__menu-item">
                        <a class="text-18 admin-header__menu-link
                        @if(Request::is('admin/full-time-education/conducting-practice') ||
                        Request::is('admin/full-time-education/conducting-practice/*') ||
                        Request::is('admin/full-time-education/recycleBin/conducting-practice') ||
                        Request::is('admin/full-time-education/recycleBin/conducting-practice/*')) admin-header__link-active @endif" href="{{ route('admin.full-time-education.conducting-practice.index') }}">
                            Փորձաշրջանի անցկացման կարգ
                        </a>
                    </li>
                    <li class="admin-header__menu-item">
                        <a class="text-18 admin-header__menu-link @if(Request::is('admin/full-time-education/behavior-rule') ||
                        Request::is('admin/full-time-education/behavior-rule/*') ||
                        Request::is('admin/full-time-education/recycleBin/behavior-rule') ||
                        Request::is('admin/full-time-education/recycleBin/behavior-rule/*')
                    ...
                    <li class="admin-header__menu-item">
                        ...
                        Request::is('admin/full-time-education/dormitory-rule/*') ||
                        Request::is('admin/full-time-education/recycleBin/dormitory-rule') ||
                        Request::is('admin/full-time-education/recycleBin/dormitory-rule/*')
                        ) admin-header__link-active @endif"
                    ...
                    <li class="admin-header__menu-item">
                        ...
                        Request::is('admin/full-time-education/provide-deferral/*') ||
                        Request::is('admin/full-time-education/recycleBin/provide-deferral') ||
                        Request::is('admin/full-time-education/recycleBin/provide-deferral/*')
                        ) admin-header__link-active @endif"
